...
flags.DEFINE_string(  # None == "/data/bert-checkpoint/chinese_L-12_H-768_A-12/bert_model.ckpt"
    "init_checkpoint", "/data/bert-checkpoint/chinese_L-12_H-768_A-12/bert_model.ckpt",
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        train_input_fn = generator_parse.file_based_input_fn_builder(
            ...
            is_training=True,
            drop_remainder=True)
        estimator.train(input_fn=train_input_fn, max_steps=num_train_steps)  # num_train_steps=最大训练步数
